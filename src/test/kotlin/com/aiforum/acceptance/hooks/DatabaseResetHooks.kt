...
class DatabaseResetHooks(
    ...
    fun resetDatabase() {
        ...
        // github_pr_thread references thread, so before thread.
        listOf("routing_event", "attachment", "vote", "comment_revision", "event_log", "comment", "thread_read", "github_pr_thread", "thread", "persona").forEach {
